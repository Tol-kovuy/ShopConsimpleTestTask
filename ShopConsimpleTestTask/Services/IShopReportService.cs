...
namespace ShopConsimpleTestTask.Services
{
    public interface IShopReportService
    {
        ...
        // Повертає список клієнтів (id, ПІБ), які придбали за останні N днів.
        // Для кожного клієнта необхідно виводити дату його останньої покупки.
        Task<IEnumerable<ClientByLastDayDto>> GetBuyersByLastDaysAsycn(int days, DateTime? referenceDate = null);
